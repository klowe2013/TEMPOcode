...
process SCHTRIAL(allowed_fix_time, 		// see ALL_VARS.pro and DEFAULT.pro
	...
	// Stim complete?  - was ultrasound stimulation already applied in this trial?
...
if (SingMode == 0)
	...
	// STAGE fixating placeholders (the subject is looking at the fixation point waiting for placeholder onset)
			...
			else if (StimCond == 0 && StimDone == 0 && In_FixWin && time() > aquire_fix_time + (curr_holdtime - 150))	// But if the eyes are still in the window at end of holdtime...
				{
