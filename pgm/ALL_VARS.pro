...
/*
declare hide int stateCMD = 1;  // countermanding
declare hide int stateFIX = 2;  // fixation
declare hide int stateMEM = 3;  // mem guided sacc
declare hide int stateGNG = 4;  // go/no-go
declare hide int stateFSF = 5;  // full screen flash
declare hide int stateDEL = 6;  // delayed saccade
declare hide int stateSRCH = 7; // search
declare hide int stateVWM = 8;  // meetacognition with masking decision task (?)
*/
...
declare float vwmAngleArray[8];

//for trial setup
declare float LocArray[6];
...
declare int testDuration = 500;
declare int testHoldDuration = 100;//1000
